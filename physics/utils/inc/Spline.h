...
//@{
  /**
    ...
    */
  Spline(double *xdata, double *ydata, int numdata, bool isconstrained = false);
...
//@{
  /**
    ...
    * @param[in] isconstrained  Flag to indicate if constrained cubic spline interpolation is requested.
    */
  void   SetUpSpline(double *xdata, double *ydata, int numdata, bool isconstrained = false);
...
// data members
private:
  /** @brief Flag to indicate is constrained natural cubic spline interpolator is required. */
