//==========================================================================
// LightTrack.h - Geant-V Prototype
/**
 * @file LightTrack.h
 * @brief Light track for the physics of Geant-V prototype
 *
 * As the name suggests, this class is supposed to be a smaller, lighter
 * version of GeantTrack, to be used by the physics processes.
 * It is foreseen that different processes, in particular electromagnetic
 * and hadronic ones, need different information: this should be placed
 * in a new object, whose class should be inherited from the (now empty)
...
private:
  ...
  int fTrackStatus;             /** Status of the track */       
...
public:
  ...
  LightTrack( const int aGVcode, const int aGTrackIndex, const int aMaterialCutCoupleIndex,
              const int aTrackStatus, const int aProcessIndex, const int aTargetZ, 
              ...
              const double aStepLength, const double aEdep, ExtraInfo* aExtraInfo = 0 );
  ...
  int GetTrackStatus() const { return fTrackStatus; }
   ...
   */
  void SetTrackStatus( const int aTrackStatus ) { fTrackStatus = aTrackStatus; }
...
private:
  ...
  int *fTrackStatusV;             /** Status of the tracks */       
