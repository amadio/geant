...
RelativisticBremsModel::RelativisticBremsModel(bool isuselpm, const std::string &modelname)
 : fIsUseLPM(isuselpm), fModelName(modelname) {
   // set default values:
   //
...
/**
  ...
  */
double RelativisticBremsModel::SamplePhotonEnergy(MaterialCuts *matcut, double eekin, double r1, double r2, double r3) {
 ...
 */
double RelativisticBremsModel::ComputeXSectionPerAtom(Element *elem, Material *mat, double gammaprodcutenergy, double particleekin) {
  double xsec = 0.0;
 ...
 */
double RelativisticBremsModel::ComputeXSectionPerVolume(Material *mat, double gammaprodcutenergy, double particleekin) {
  double xsec = 0.0;
  if (particleekin<=gammaprodcutenergy) {
//    std::cerr<<" particleekin = "<<particleekin/geant::MeV<< " gammaprodcutenergy = "<<gammaprodcutenergy/geant::MeV << std::endl;
    return xsec;
 ...
 */
double RelativisticBremsModel::ComputeDEDXPerVolume(Material *mat, double gammaprodcutenergy, double particleekin) {
  double dedx = 0.0;
  // TODO
  ...
  return log1mKappaCr*factor*integral;
}
