...
//@}
   ...
   */
  double ComputeDEDXPerVolume(Material *mat, double prodcutenergy, double particleekin);
   ...
   */
  double ComputeXSectionPerAtom(Element *elem, Material *mat, double prodcutenergy, double particleekin);
   ...
   */
  double ComputeXSectionPerVolume(Material *mat, double prodcutenergy, double particleekin);
  ...
  /**
    ...
    */
  double SampleEnergyTransfer(MaterialCuts *matcut, double primekin, double r1, double r2, double r3);
