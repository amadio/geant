...
//@}
   ...
   */
  double ComputeXSectionPerAtom(Element *elem, Material *mat, double gammaprodcutenergy, double particleekin);
   ...
   */
  double ComputeXSectionPerVolume(Material *mat, double gammaprodcutenergy, double particleekin);
   ...
   *                               [energy/lenght] units.
   */
  double ComputeDEDXPerVolume(Material *mat, double gammaprodcutenergy, double particleekin);
