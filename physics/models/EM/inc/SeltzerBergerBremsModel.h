...
//@}
   ...
   */
  double ComputeXSectionPerAtom(Element *elem, Material *mat, double gammaprodcutenergy, double electronekin);
   ...
   */
  double ComputeXSectionPerVolume(Material *mat, double gammaprodcutenergy, double electronekin);
   ...
   *                               [energy/lenght] units.
   */
  double ComputeDEDXPerVolume(Material *mat, double gammaprodcutenergy, double electronekin);
   ...
   */
  double SamplePhotonEnergy(MaterialCuts *matcut, double eekin, double r1, double r2, double r3);

// additional getters/setters should be provided later!
/**
 * @name Field related setters/getters:
 */
//@{
  /** @brief Get name of the model. */
  const std::string& GetName()     {return fModelName;}
//@}
...
private:
 ...
 int     fNumMaterialCuts;                  // number of different matrial-gammacut pairs
 ...
 /** @brief Map from global to local material-gamma production cut indices. The size of the array is
   *        SeltzerBergerBremsModel::fNumMaterialCuts.
   */
