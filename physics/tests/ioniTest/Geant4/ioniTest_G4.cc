...
int main(int argc, char **argv)
{
  ...
  if (energy <= minE) {
    G4cout << " *** Primary energy = " << energy / MeV << " [MeV] is <= minimum energy = " << minE / MeV
           << " [MeV] so there is no secondary e- production at this energy!" << G4endl;
    return 0;
  }
...
void help()
{
  ...
  G4cout << "  Geant4 ioniTest application for testing Geant4 e-/e+ model for ionization." << G4endl;
