...
struct MSCdata {
  ...
  /**
   * @brief Function that set the new X, Y, Z directions proposed by msc (will be applied or not depending other
   * conditions)
   *
...
fIsFirstStep=%d fIsFirstRealStep=%d\n",
           fLambda0, fLambda1, fScrA, fG1, fRange, fTheInitialRange, fTheTrueStepLenght, fTheTransportDistance,
           fTheZPathLenght, fTheTrueGeomLimit, fTheDisplacementVectorX, fTheDisplacementVectorY,
           fTheDisplacementVectorZ, fTheNewDirectionX, fTheNewDirectionY, fTheNewDirectionZ, fPar1, fPar2, fPar3,
           fIsEverythingWasDone, fIsMultipleSacettring, fIsSingleScattering, fIsEndedUpOnBoundary, fIsNoScatteringInMSC,
           fIsNoDisplace, fIsInsideSkin, fIsWasOnBoundary, fIsFirstStep, fIsFirstRealStep);
  }
};
}
