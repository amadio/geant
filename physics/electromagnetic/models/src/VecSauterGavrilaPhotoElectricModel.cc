...
IndexD_v VecSauterGavrilaPhotoElectricModel::SampleShellAliasVec(Double_v egamma, IndexD_v zed, Double_v r1,
                                                                 Double_v r2)
{
  ...
  if (enableSamplingShells.isNotEmpty()) {
    ...
    if (lowEn.isNotEmpty()) {
      ...
      //            for (int k=0; k<kVecLenD; k++){
      //
      //            if(lGammaEnergy_v[k]>fShellLSamplingPrimEnergiesNEW[zed[k]][tableIndex_v[k]+1] || lGammaEnergy_v[k]<
      //            fShellLSamplingPrimEnergiesNEW[zed[k]][tableIndex_v[k]]+1) {
      //                std::cout<< "******* Error\n";
      //                exit(-1);
      //            }else  std::cout<< "***OK\n";
      //            }
...
Double_v VecSauterGavrilaPhotoElectricModel::SamplePhotoElectronDirectionAliasVec(Double_v egamma, Double_v r1,
...
void VecSauterGavrilaPhotoElectricModel::SampleShellVec(double *egamma, int *zed, int *ss, int N,
...
void VecSauterGavrilaPhotoElectricModel::SamplePhotoElectronDirectionRejVec(const double *egamma, double *cosTheta,
