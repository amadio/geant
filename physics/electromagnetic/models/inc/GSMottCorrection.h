 ...
 * @date    November 2017
 *
 * @brief  Mott-correction data for the GS-MSC model.
 *
 * An object of this calss is used in the GSMSCTable when Mott-correction
 * was required by the user in the GSMSCMscModel.
 ...
 *
 * References:
 *   [1] I.Kawrakow, E.Mainegra-Hing, D.W.O.Rogers, F.Tessier,B.R.B.Walters, NRCC Report PIRS-701 (2013)
