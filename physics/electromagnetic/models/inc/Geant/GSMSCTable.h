...
public:
  ...
  double SampleCosTheta(double lambdaval, double qval, double scra, double lekin, double beta2, int matindx,
                        GSMSCAngularDtr **gsDtr, int &mcekini, int &mcdelti, double &transfPar, geant::TaskData *td,
                        bool isfirst);

  double SampleGSSRCosTheta(const GSMSCAngularDtr *gsDrt, double transfpar, geant::TaskData *td);

  double SingleScattering(double lambdaval, double scra, double lekin, double beta2, int matindx, geant::TaskData *td);
