#ifndef NeutronNudyFissionModel_H
#define NeutronNudyFissionModel_H
...
class NeutronNudyFissionModel : public HadronicFinalStateModel {
public:
  /**
   ...
   */
  NeutronNudyFissionModel(const std::string &modelname = "NeutronNudyFission");
  /** @brief Destructor. */
  ~NeutronNudyFissionModel();
  //@}
