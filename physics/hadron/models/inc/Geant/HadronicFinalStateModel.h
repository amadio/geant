...
public:
  ...
  HadronicFinalStateModel(const std::string name, const std::vector<int> &projectilecodevec,
                          ...
                          const double mintargetz, const double maxtargetz, const double mintargetn,
  ...
  virtual int SampleFinalState(LightTrack &track, Isotope *targetisotope, geant::TaskData *td) = 0;
