...
HadronicFinalStateModel::HadronicFinalStateModel(const std::string name, const std::vector<int> &projectilecodevec,
                                                 const HadronicModelType type, const double minenergy,
                                                 const double maxenergy, const double mintargetz,
                                                 const double maxtargetz, const double mintargetn,
                                                 const double maxtargetn)
...
HadronicFinalStateModel::HadronicFinalStateModel(const HadronicFinalStateModel &other)
    : fName(other.fName), fType(other.fType), fLowEnergyUsageLimit(other.fLowEnergyUsageLimit),
      fHighEnergyUsageLimit(other.fHighEnergyUsageLimit), fMinTargetZ(other.fMinTargetZ),
      fMaxTargetZ(other.fMaxTargetZ), fMinTargetN(other.fMinTargetN), fMaxTargetN(other.fMaxTargetN)
{
...
bool HadronicFinalStateModel::IsApplicable(const int projectilecode, const double projectilekineticenergy,
