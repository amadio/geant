...
double GlauberGribovElasticXsc::GetIsotopeCrossSection(const int particleCode, const double energyKin,
                                                       const double mass, const int Z, const int N)
{
  double HadronNucleusElasticXsc = GGTotalXsc->GetIsotopeCrossSection(particleCode, energyKin, mass, Z, N) -
