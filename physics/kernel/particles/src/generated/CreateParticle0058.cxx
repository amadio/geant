...
void CreateParticle0058() {
   ...
   // Creating ~gravitino
   new ParticleOld("~gravitino", 1000039, 0, "Sparticle", 100, 0, 500, 0, -100, -1, -100, -1, -1);

   // Creating ~d_R
   new ParticleOld("~d_R", 2000001, 1, "Sparticle", 100, -0.333333, 500, 1, -100, -1, -100, -1, -1);
   part = const_cast<ParticleOld*>(&ParticleOld::Particles().at(2000001));
   daughters.clear();
   ...
   // Creating ~u_R
   new ParticleOld("~u_R", 2000002, 1, "Sparticle", 100, 0.666667, 500, 1, -100, -1, -100, -1, -1);
   part = const_cast<ParticleOld*>(&ParticleOld::Particles().at(2000002));
   daughters.clear();
   daughters.push_back(1000039);
   daughters.push_back(2);
   part->AddDecay(ParticleOld::Decay(53, 0,  daughters));
   ...
   // Creating ~s_R
   new ParticleOld("~s_R", 2000003, 1, "Sparticle", 100, -0.333333, 500, 1, -100, -1, -100, -1, -1);
   ...
   // Creating ~c_R
   new ParticleOld("~c_R", 2000004, 1, "Sparticle", 100, 0.666667, 500, 1, -100, -1, -100, -1, -1);
