...
int main()
{
  ...
  Material *CO2 =
      new Material(name = "Carbonic gas", density, numcomponents = 2, MaterialState::kStateGas, temperature, pressure);
  ...
  Material *C4H10 =
      new Material(name = "isobutane", density, numcomponents = 2, MaterialState::kStateGas, temperature, pressure);
  ...
  Material *steam =
      new Material(name = "Water steam ", density, numcomponents = 1, MaterialState::kStateGas, temperature, pressure);
  ...
  new Material(name = "Galactic", z = 1., a = 1.01 * g / mole, density, MaterialState::kStateGas, temperature,
               pressure);
  ...
  Material *beam =
      new Material(name = "Beam ", density, numcomponents = 1, MaterialState::kStateGas, temperature, pressure);
  ...
  std::cout << " Checking uniqueness of isotopes in the global isotope table" << std::endl
            ...
            << "     Index of the received isotope in the global isotope table =  " << iso->GetIndex() << " = 11 ?"
            << std::endl
            << std::endl;
