...
//______________________________________________________________________________
TPrimaryGenerator::TPrimaryGenerator(Int_t partpdg, Double_t partekin, 
                    Double_t xpos, Double_t ypos, Double_t zpos, Double_t xdir, 
...
//______________________________________________________________________________
void TPrimaryGenerator::InitPrimaryTrack(GeantTrack &gtrack){
     gtrack.SetPDG(fPDG);
