...
void TTabPhysProcess::ApplyMsc(TGeoMaterial * /*mat*/, Int_t /*ntracks*/, GeantTrack_v & /*tracks*/,
                               GeantTaskData * /*td*/) {
...
//______________________________________________________________________________
GEANT_CUDA_DEVICE_CODE
void TTabPhysProcess::Eloss(TGeoMaterial *mat, Int_t ntracks, GeantTrack_v &tracks, Int_t &nout, GeantTaskData *td) {
...
//______________________________________________________________________________
void TTabPhysProcess::ComputeIntLen(TGeoMaterial *mat, Int_t ntracks, GeantTrack_v &tracks, Double_t * /*lengths*/,
                                    GeantTaskData *td) {
...
//______________________________________________________________________________
void TTabPhysProcess::PostStepTypeOfIntrActSampling(TGeoMaterial *mat, Int_t ntracks, GeantTrack_v &tracks,
                                                    GeantTaskData *td) {
...
//______________________________________________________________________________
void TTabPhysProcess::PostStepFinalStateSampling(TGeoMaterial *mat, Int_t ntracks, GeantTrack_v &tracks, Int_t &nout,
                                                 GeantTaskData *td) {
