...
public:
  ...
  virtual void PostStep(Material_t * /*mat*/, Int_t /*ntracks*/, GeantTrack_v & /*tracks */, Int_t & /*nout*/,
                        GeantTaskData * /*td*/) {}
  ...
  virtual void PostStepTypeOfIntrActSampling(Material_t *mat, Int_t ntracks, GeantTrack_v &tracks, GeantTaskData *td);
  ...
  virtual void Eloss(Material_t *mat, Int_t ntracks, GeantTrack_v &tracks, Int_t &nout, GeantTaskData *td);
  GEANT_CUDA_DEVICE_CODE
