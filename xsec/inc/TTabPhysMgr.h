...
public:
  ...
  // Int_t SampleInt(Int_t imat, Int_t ntracks, GeantTrack_v &tracks, GeantTaskData *td);

  // # smapling: target atom and type of the interaction for each primary tracks
  void SampleTypeOfInteractions(Int_t imat, Int_t ntracks, GeantTrack_v &tracks, GeantTaskData *td);
  ...
  Int_t SampleFinalStates(Int_t imat, Int_t ntracks, GeantTrack_v &tracks, GeantTaskData *td);

  GEANT_CUDA_DEVICE_CODE
  void GetRestFinStates(Int_t partindex, TMXsec *mxs, Double_t energyLimit, GeantTrack_v &tracks, Int_t iintrack,
                        Int_t &nTotSecPart, GeantTaskData *td);
  void SampleDecayInFlight(Int_t partindex, TMXsec *mxs, Double_t energyLimit, GeantTrack_v &tracks, Int_t iintrack,
                           Int_t &nTotSecPart, GeantTaskData *td);

  GEANT_CUDA_DEVICE_CODE
  Bool_t HasRestProcess(Int_t gvindex);

  void RotateNewTrack(Double_t oldXdir, Double_t oldYdir, Double_t oldZdir, GeantTrack &track);
  GEANT_CUDA_DEVICE_CODE
  void RotateNewTrack(Double_t oldXdir, Double_t oldYdir, Double_t oldZdir, GeantTrack_v &tracks, Int_t itrack);
