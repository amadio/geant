...
public:
  ...
  Bool_t SetPartMS(const Float_t angle[], const Float_t ansig[], const Float_t length[], const Float_t lensig[]);
  ...
  Bool_t MS(Double_t en, Float_t &ang, Float_t &asig, Float_t &len, Float_t &lsig) const;
  Bool_t Resample();
  Bool_t Prune();
  ...
  void Dump() const;
  void Interp(Double_t egrid[], Float_t value[], Int_t nbins, Double_t eildelta, Int_t stride, Double_t en,
              Float_t result[]);
