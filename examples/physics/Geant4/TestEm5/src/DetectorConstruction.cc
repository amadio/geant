...
DetectorConstruction::DetectorConstruction()
    : G4VUserDetectorConstruction(), fAbsorberMaterial(0), fWorldMaterial(0), fDefaultWorld(true), fSolidWorld(0),
      fLogicWorld(0), fPhysiWorld(0), fSolidAbsorber(0), fLogicAbsorber(0), fPhysiAbsorber(0), fDetectorMessenger(0)
{
...
void DetectorConstruction::DefineMaterials()
{
  ...
  G4Material *Air20 =
      new G4Material("Air20", density = 1.205 * mg / cm3, ncomponents = 2, kStateGas, 293. * kelvin, 1. * atmosphere);
  ...
  new G4Material("XenonGas", z = 54, a = 131.29 * g / mole, density = 5.458 * mg / cm3, kStateGas, 293.15 * kelvin,
                 1 * atmosphere);
  ...
  G4Material *NewArCO2 = new G4Material("NewArgonCO2", density = 1.8223 * mg / cm3, ncomponents = 3);
  ...
  G4Material *XeCH = new G4Material("XenonMethanePropane", density = 4.9196 * mg / cm3, ncomponents = 3, kStateGas,
...
G4VPhysicalVolume *DetectorConstruction::ConstructCalorimeter()
{
  ...
  // Absorber
  //
  fSolidAbsorber = new G4Box("Absorber", fAbsorberThickness / 2, fAbsorberSizeYZ / 2, fAbsorberSizeYZ / 2);
...
void DetectorConstruction::PrintCalorParameters()
{
  ...
  G4cout << "\n The  WORLD   is made of " << G4BestUnit(fWorldSizeX, "Length") << " of " << fWorldMaterial->GetName();
  G4cout << ". The transverse size (YZ) of the world is " << G4BestUnit(fWorldSizeYZ, "Length") << G4endl;
