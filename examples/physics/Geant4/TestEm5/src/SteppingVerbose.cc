...
void SteppingVerbose::TrackingStarted()
{
  ...
  if (verboseLevel > 0) {
    G4cout << std::setw(5) << "Step#"
           ...
           << "    " << std::setw(9) << "KineE"
           << " " << std::setw(11) << "dEStep"
           << " " << std::setw(11) << "StepLeng" << std::setw(12) << "TrakLeng" << std::setw(10) << "Volume"
           << "    "
           << "Process" << G4endl;
    ...
    G4cout << std::setw(5) << fTrack->GetCurrentStepNumber() << " " << std::setw(6)
           ...
           << G4BestUnit(fTrack->GetTrackLength(), "Length") << std::setw(10) << fTrack->GetVolume()->GetName()
           << "  initStep" << G4endl;
  }
      ...
      if (nbtrk) {
        ...
        for (size_t lp = 0; lp < (*secondary).size(); lp++) {
          G4cout << "   " << std::setw(13) << (*secondary)[lp]->GetDefinition()->GetParticleName()
                 << ":  energy =" << std::setw(6) << G4BestUnit((*secondary)[lp]->GetKineticEnergy(), "Energy")
                 << "  time =" << std::setw(6) << G4BestUnit((*secondary)[lp]->GetGlobalTime(), "Time");
          G4cout << G4endl;
        }
