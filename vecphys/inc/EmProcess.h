...
public:
  ...
  template <typename Backend>
  VECCORE_CUDA_HOST_DEVICE
  void G3StepLengthAndProcess(GUTrack& track, const int materialIndex);

  template <typename Backend>
  VECCORE_CUDA_HOST_DEVICE
  void GetNextStep(Index_v<typename Backend::Double_v> materialIndex,
  ...
  GetNextProcess(Index_v<typename Backend::Double_v> materialIndex,
                 Index_v<typename Backend::Double_v> ebin);
...
template <class Process>
VECCORE_CUDA_HOST 
EmProcess<Process>::EmProcess(Random_t* states, int tid) 
  : fRandomState(states), fThreadId(tid), 
  fNumberOfProcess(0),
  fNumberOfEnergyBin(100),
  fNumberOfMaterialBin(0),
...
template <class Process>
VECCORE_CUDA_HOST 
void EmProcess<Process>::BuildCrossSectionTable() 
{ 
...
template <class Process>
VECCORE_CUDA_HOST 
void EmProcess<Process>::PrintCrossSectionTable() 
{ 
...
EmProcess<Process>::GetStepLengthAndProcess(GUTrack& track, const int materialIndex)
{
...
template <typename Backend>
void
EmProcess<Process>::GetStepLengthAndProcess(GUTrack_v& tracks, const int* materialIndex)
{
  using Double_v = typename Backend::Double_v;
  typedef Index_v<typename Backend::Double_v> Index_t;
...
template <typename Backend>
void
EmProcess<Process>::GVStepLengthAndProcess(GUTrack_v& tracks, const int* materialIndex)
{
  using Double_v = typename Backend::Double_v;
  typedef Index_v<typename Backend::Double_v> Index_t;
...
VECCORE_CUDA_HOST_DEVICE
void
EmProcess<Process>::GetNextStep(Index_v<typename Backend::Double_v> matId,
                                Index_v<typename Backend::Double_v> ebin,
                                typename Backend::Double_v efrac,
                                typename Backend::Double_v& nint,
                                typename Backend::Double_v& lambda,
...
VECCORE_CUDA_HOST_DEVICE
Index_v<typename Backend::Double_v>
EmProcess<Process>::GetNextProcess(Index_v<typename Backend::Double_v> matId,
                                   Index_v<typename Backend::Double_v> ebin) 
{
...
template <typename Backend>
VECCORE_CUDA_HOST_DEVICE void
EmProcess<Process>::G3StepLengthAndProcess(GUTrack& track, const int materialIndex)
{
  using Double_v = typename Backend::Double_v;
  typedef Index_v<typename Backend::Double_v> Index_t;
