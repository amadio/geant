...
namespace R123 {
  ...
  template<typename Backend> using array4_t = typename Backend::UInt32_v [4];
  template<typename Backend, unsigned int N> using array_t = typename Backend::UInt32_v [N];
