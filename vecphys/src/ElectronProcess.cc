...
VECCORE_CUDA_HOST
ElectronProcess::ElectronProcess(Random_t* states, int tid) 
  : EmProcess<ElectronProcess>(states,tid)
{
  fNumberOfProcess = 2;
  fIonisation = 0;
  fBremsstrahlung = 0;
...
ElectronProcess::Initialization()
{
  ...
  fElectronCrossSectionData = (ElectronCrossSectionData**) malloc(sizeof(ElectronCrossSectionData*)*fNumberOfMaterialBin);

  for (int i = 0 ; i < fNumberOfMaterialBin ; ++i) {
    fElectronCrossSectionData[i] = (ElectronCrossSectionData*) malloc(sizeof(ElectronCrossSectionData)*fNumberOfEnergyBin);
  }
...
VECCORE_CUDA_HOST void 
ElectronProcess::BuildCrossSectionTable()
{
...
VECCORE_CUDA_HOST void 
ElectronProcess::PrintCrossSectionTable()
{
