...
#ifndef VECPHYS_BACKEND_CUDA_INTERFACE_H_
#define VECPHYS_BACKEND_CUDA_INTERFACE_H_
...
Type* AllocateOnDevice() {
  Type *ptr;
  vecphys::cxx::CudaAssertError(vecphys::cxx::CudaMalloc((void**)&ptr, sizeof(Type)));
  return ptr;
}
...
protected:
   ...
   void Malloc(unsigned long size) {
      vecphys::cxx::CudaAssertError(vecphys::cxx::CudaMalloc((void**)&fPtr, size));
   }
   void Free() {
      vecphys::cxx::CudaAssertError(vecphys::cxx::CudaFree((void*)fPtr));
   }
...
} // End vecphys namespace

#endif // VECPHYS_CUDA

#endif // VECPHYS_BACKEND_CUDA_INTERFACE_H_
