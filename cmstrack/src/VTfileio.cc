...
VTfileio::VTfileio()
    : fOutFile(0), fCurTree(0), fX(0), fY(0), fZ(0), fPx(0), fPy(0), fPz(0), fPID(0), fLVid(0), fShapeid(0), fSafety(0),
      fSnext(0), fStep(0), fSurfid(0), fProcess(0), fBegEnd(0), fTrid(0), fTrPid(0), fCPUtime(0), fCPUstep(0),
      fNewEvent(0), fNprimaries(0), fVolumeDictionary(new THashList), fShapeDictionary(new THashList),
