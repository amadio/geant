...
public:
  ...
  /** @brief GetNumber of basketized tracks */
  VECCORE_ATT_HOST_DEVICE
  GEANT_FORCE_INLINE
  virtual size_t GetNstored() const { return fBasketizer->GetNstored(); }
...
public:
  ...
  VECCORE_ATT_HOST_DEVICE
  GEANT_FORCE_INLINE
  virtual size_t GetNstored() const { return fLocalBasket.size(); }
