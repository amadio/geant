...
void runLHCb(const int ncputhreads = 4, const bool performance = true,
             ...
             const char *eventfile = "../../pp14TeVminbias.root", const float magfield = 10.,
             ...
             )
{
  ...
  //   prop->fPrimaryGenerator = new GunGenerator(1, 0, 1., 0, 0, 0, 0.362783697740757, 0.259450124768640,
  //   0.882633622956438);
