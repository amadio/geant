...
LocalityManager::LocalityManager()
    : fInitialized(false), fPolicy(NumaPolicy::kSysDefault), fNnodes(0), fTrackMgr(nullptr), fNblocks(0), fBlockSize(0)
{
  // Private constructor.
  fgInstance = this;
}
...
void LocalityManager::Init()
{
  ...
  std::cout << "=== Locality manager allocated " << fNblocks << " blocks of " << fBlockSize << " tracks each on "
            << fNnodes << " locality nodes ===" << std::endl;
  fInitialized = true;
}
