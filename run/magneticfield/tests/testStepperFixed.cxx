...
int main(int argc, char *args[])
{
  ...
  if (argc > 1) {
    if ((strcmp(args[1], "-h") == 0) || (strcmp(args[1], "-u") == 0) || (strcmp(args[1], "--help") == 0) ||
  ...
  cout << "#DEBUG> Field value from ScalarUniformMagField = " << fieldVec[0] / fieldUnits::kilogauss << " ,  "
       << fieldVec[1] / fieldUnits::kilogauss << " , " << fieldVec[2] / fieldUnits::kilogauss << " KGauss " << endl;

  cout << "#  Initial  momentum * c = " << x_mom << " , " << y_mom << " , " << z_mom << " GeV " << endl;
  // Create an Equation :
  auto gvEquation = FieldEquationFactory::CreateMagEquation<ScalarUniformMagField>(gvField);
  ...
  double dydx[8] = {0., 0., 0., 0., 0., 0., 0., 0.}, // 2 extra safety buffer
      dydxRef[8] = {0., 0., 0., 0., 0., 0., 0., 0.}, yout[8] = {0., 0., 0., 0., 0., 0., 0., 0.},
         youtX[8] = {0., 0., 0., 0., 0., 0., 0., 0.}, yerr[8] = {0., 0., 0., 0., 0., 0., 0., 0.},
