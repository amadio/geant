...
int main(int argc,char **argv)
{
  ...
  LHCbApp::fgIsScoreActive = FALSE; 
  if(scoreType > 1)
    LHCbApp::fgIsScoreActive = TRUE;
...
void usage()
{
  ...
  "    complextest ----------- Geant4 test with complex geometry ------------- " 
       << G4endl << G4endl <<
  "[SYNOPSIS]" << G4endl <<
  "    testlhcb --geomFile [FILE] --eventFile [FILE] --g4macroFile [FILE] \n"
  ...
  "    provide to testlhcb as an input parameter through the -l flag in [GeV] \n"
  ...
  "                          2 : option 2 plus histograms in LHCb ECAL            \n"
          << G4endl <<        
  " --info                : print all information regarding testlhcb          \n"
  << G4endl <<  
  "============================================================================"
  << G4endl << G4endl; 
}
