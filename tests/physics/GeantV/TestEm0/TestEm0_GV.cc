...
static struct option options[] = {
    {"particle-name    (possible particle names: e-, e+, gamma)                 - default: e-", required_argument, 0,
     'p'},
...
int main(int argc, char *argv[])
{
  ...
  double compTotalUnRestrictedDEDX =
      0.0;                          // the corresponding can be obtained from table as well (if CSDA range is TRUE)
  ...
  if (isHasEnergyLossProcess) {
    ...
    for (size_t i = 0; i < processNameVect.size(); ++i) {
      std::cout << std::setw(14) << std::scientific << std::right
                << compRestrictedDEDXVect[i] / (geant::units::MeV / geant::units::cm) << std::setw(14) << std::left
                << "   [MeV/cm]";
    }
    std::cout << std::endl;
    ...
    std::cout << std::setw(29) << std::setfill('.') << std::right << " ( interpolated from" << std::left
              ...
              << std::setfill(' ') << std::setw(14) << std::left << "   [MeV/cm]";
    std::cout << std::endl;
    std::cout << std::endl;
    ...
    for (size_t i = 0; i < processNameVect.size(); ++i) {
      std::cout << std::setw(14) << std::scientific << std::right
                << compRestrictedDEDXVect[i] / (geant::units::MeV / geant::units::cm) / density << std::setw(14)
                << std::left << " [MeVcm2/g]";
    }
    std::cout << std::endl;
    ...
    std::cout << "   restricted dE/dx (MeVcm2/g) :";
    std::cout << std::setw(29) << std::setfill('.') << std::right << " ( interpolated from" << std::left
              << " the ELossTable )" << std::setw(24) << std::scientific << std::right << getRestrictedDEDX / density
              << std::setfill(' ') << std::setw(14) << std::left << " [MeVcm2/g]";
    std::cout << std::endl;
    std::cout << std::endl;
    ...
    for (size_t i = 0; i < processNameVect.size(); ++i) {
      std::cout << std::setw(14) << std::scientific << std::right
                << compUnRestrictedDEDXVect[i] / (geant::units::MeV / geant::units::cm) << std::setw(14) << std::left
                << "   [MeV/cm]";
    }
    std::cout << std::endl;
    ...
    for (size_t i = 0; i < processNameVect.size(); ++i) {
      std::cout << std::setw(14) << std::scientific << std::right
                << compUnRestrictedDEDXVect[i] / (geant::units::MeV / geant::units::cm) / density << std::setw(14)
                << std::left << " [MeVcm2/g]";
    }
    std::cout << std::endl;
    std::cout << std::endl;
    ...
    std::cout << std::setw(29) << std::setfill('.') << std::right << " ( interpolated from" << std::left
              ...
              << std::setfill(' ') << std::setw(14) << std::left << "       [mm]";
    std::cout << std::endl;
...
void help()
{
  ...
  std::cout
      << "  TestEm0 like GeantV application for testing integrated physics quantities using a given user physics-list"
      << std::endl;
