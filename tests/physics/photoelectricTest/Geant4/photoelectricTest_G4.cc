...
static struct option options[] = {
    ...
    {"model-name        (photoelectricFluo, photoelectricLiv)       - default: photoelectricLiv", required_argument, 0,
     'b'},
...
void help()
{
  ...
  G4cout << "  Geant4 photoelectricTest application for testing some Geant4 gamma models for photoelectric." << G4endl;
