...
static struct option options[] = {
    {"material-name     (with a G4_ prefix i.e. NIST material)               - default: G4_Pb", required_argument, 0,
     'm'},
    {"model-name        (bhPair (Bethe-Heitler) or relPair (Relativistic))   - default: bhPair", required_argument, 0,
     'c'},
    {"primary-energy    (in internal energy units i.e. [MeV])                - default: 100", required_argument, 0,
     'E'},
    {"number-of-samples (number of required final state samples)             - default: 1.e+7", required_argument, 0,
     'f'},
...
void help()
{
  ...
  G4cout << "  Geant4 conversionTest application for testing Geant4 Bethe-Heitler model for e-/e+"
         << "  pair production by photons." << G4endl;
