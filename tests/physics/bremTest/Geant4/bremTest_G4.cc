...
int main(int argc, char **argv)
{
  ...
  if (energy <= gammaCutEnergy) {
    G4cout << " *** Primary energy = " << energy / MeV << " [MeV] is <= gamma production cut = " << gammaCutEnergy / MeV
           << " [MeV] so there is no secondary gamma production at this energy!" << G4endl;
    return 0;
  }
...
void help()
{
  ...
  G4cout << "  Geant4 bremTest application for testing some Geant4 e-/e+ models for bremsstrahlung." << G4endl;
