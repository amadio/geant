...
public:
  ...
  void SetDesc   (const Char_t *desc, int i);
  void SetNXC    (int nxc);
  ...
  void SetHSUB   (Char_t *hsub, int i) {strncpy(fHSUB[i],hsub,66), fHSUB[i][66] = '\0';}
  ...
  const Char_t* GetDesc(int i)   const;
  ...
  const Char_t* GetHSUB(int i) const {return fHSUB[i];}
