...
private:
  ...
  // -----
  double fLastStepLength, fCharge;
...
inline GUTCashKarpRKF45<T_Equation, Nvar>::GUTCashKarpRKF45(T_Equation *EqRhs,
    ...
    : VScalarIntegrationStepper(EqRhs, // dynamic_cast<VScalarEquationOfMotion*>(EqRhs),
      ...
      fEquation_Rhs(EqRhs), fOwnTheEquation(true), fAuxStepper(0), fLastStepLength(0.), fCharge(0.0), fVerbose(verbose)
{
...
inline GUTCashKarpRKF45<T_Equation, Nvar>::GUTCashKarpRKF45(const GUTCashKarpRKF45 &right)
    : VScalarIntegrationStepper((VScalarEquationOfMotion *)0, kOrderMethod, Nvar, right.GetNumberOfStateVariables()),
      ...
      fLastStepLength(0.), fCharge(0.), fVerbose(right.fVerbose)
{
...
template <class T_Equation, unsigned int Nvar>
inline double GUTCashKarpRKF45<T_Equation, Nvar>::DistChord() const
{
  ...
  fAuxStepper->GUTCashKarpRKF45::StepWithErrorEstimate(fLastInitialVector, fLastDyDx, fCharge, 0.5 * fLastStepLength,
