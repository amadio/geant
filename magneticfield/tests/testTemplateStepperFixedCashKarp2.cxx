...
int main(/*int argc, char *args[]*/)
{
  ...
  // Field
  auto gvField =
      new TemplateScalarUniformMagField<Backend>(fieldUnits::tesla * ThreeVector_d(x_field, y_field, z_field));
#ifdef DEBUGAnanya
...
// TemplateGUTCashKarpRKF45<Backend,GvEquationType,Nposmom> myStepper2(gvEquation);
  ...
  //                  X_mom * ppGVf ,Y_mom * ppGVf ,Z_mom * ppGVf};
  double yOneIn[] = {x_pos * mmGVf, y_pos * mmGVf, z_pos * mmGVf, x_mom * ppGVf, y_mom * ppGVf, z_mom * ppGVf};
  ...
  Double dydx[8] = {0., 0., 0., 0., 0., 0., 0., 0.}, // 2 extra safety buffer
      yout[8] = {0., 0., 0., 0., 0., 0., 0., 0.}, yerr[8] = {0., 0., 0., 0., 0., 0., 0., 0.};
  ...
  /*    cout<<"Starting "<<endl;
      using  GvEquationTypeScalar=  TemplateTMagFieldEquation<vecgeom::kScalar,
     TemplateScalarUniformMagField<vecgeom::kScalar>, Nposmom>;
      auto gvFieldScalar= new TemplateScalarUniformMagField<vecgeom::kScalar>( fieldUnits::tesla *
     ThreeVector_d(x_field, y_field, z_field) );
      auto gvEquationScalar =
         TemplateFieldEquationFactory<vecgeom::kScalar>::CreateMagEquation<TemplateScalarUniformMagField<vecgeom::kScalar>
     >(gvFieldScalar);
