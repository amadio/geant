...
//      G4cout << "\t" << std::setw(13) << G4BestUnit(sigma0[j], "Surface");
      for (size_t j=0; j<sigma0.size();j++) {
        G4cout << "\t" << std::setw(14) << std::scientific << std::right << sigma0[j]/barn
  ...
  for (size_t j=0; j<sigma0.size();j++) {
    G4cout << "\t" << std::setw(14) << std::scientific << std::right << sigma0[j]*cm
           << std::setw(14) << std::left << "     [1/cm]";
  }
  G4cout << "\n  cross section per volume : ";
  for (size_t j=0; j<sigma1.size();j++) {
    G4cout << "\t" << std::setw(14) << std::scientific << std::right << sigma1[j]*cm
           << std::setw(14) << std::left << "     [1/cm]";
  }

  G4cout << "\n  cross section per mass   : ";
  for (size_t j=0; j<sigma2.size();j++) {
    G4cout << "\t" << std::setw(14) << std::scientific << std::right << sigma2[j]/(cm2/g)
  ...
  for (size_t j=0; j<sigma1.size();j++) {
    ...
    G4cout << "\t" << std::setw(14) << std::scientific << std::right << lambda/cm
  ...
  for (size_t j=0; j<sigma2.size();j++) {
    ...
    G4cout << "\t" << std::setw(14) << std::scientific << std::right << lambda/(g/cm2)
  ...
  G4cout << "\n \n  restricted dE/dx         : ";
  for (size_t j=0; j<=nproc; j++) {
    G4cout << "\t" << std::setw(14) << std::scientific << std::right << dedx1[j]/(MeV/cm)
  ...
  G4cout << "\n      (MeVcm2/g)          : ";
  for (size_t j=0; j<=nproc; j++) {
    G4cout << "\t" << std::setw(14) << std::scientific << std::right << dedx2[j]/(MeV*cm2/g)
  ...
  G4cout << "\n \n  range from restrict dE/dx: "
         << "\t" << std::setw(14) << std::scientific << std::right << range1/mm
