...
extern void foo();
// this is the actual kernel doing the computation with possibility of early return
vd4 DistFromOutside_VECEXT_P4(vd4 const &x, vd4 const &y, vd4 const &z, vd4 const &dirx, vd4 const &diry,
                              vd4 const &dirz, double dx, double dy, double dz, const vd4 origin[3], vd4 const &stepmax,
                              vd4 const &distance) {
