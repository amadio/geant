...
BUILD_DIR="${WORK_DIR}/geant4.9.6.p01-orig/build-nonRandom"
SOURCE_DIR="${WORK_DIR}/geant4.9.6.p01-orig"
...
cmake -DCMAKE_CXX_COMPILER=${G4P_CXX} \
      ...
      -DCMAKE_CXX_FLAGS_RELWITHDEBINFO="-O2 -g -fno-omit-frame-pointer -DGPUDEBUG" \
