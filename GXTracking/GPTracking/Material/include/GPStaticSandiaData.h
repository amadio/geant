...
namespace GPSandiaData {

VARTYPE G4double fSandiaTable[981][5] = 
{
...
VARTYPE G4int fNbOfIntervals [101] = 
{
...
VARTYPE G4double fZtoAratio[101] = 
{
...
VARTYPE G4double fIonizationPotentials[101] =
{
     0,  // nonexisting 'zero' element
...
VARTYPE G4int fNumberOfElements  = 100 ;

VARTYPE G4int fIntervalLimit     = 100 ;

VARTYPE G4int fNumberOfIntervals = 980 ;

VARTYPE G4double funitc[5] = {keV,
			      cm2*keV/g,     
			      cm2*keV*keV/g,     
			      cm2*keV*keV*keV/g,     
...
G4double fSandiaCofPerAtom[4] = {0.0};
