...
public:
  ...
  FQUALIFIER G4double AlongStepGetPhysicalInteractionLength(GPTrack* dp, double currentMinimalStep, GPGPILSelection* selection);
  FQUALIFIER G4double ComputeTruePathLengthLimit(GPTrack* dp, double currentMinimalStep);
  ...
  FQUALIFIER G4double SampleScattering(GPTrack* dp);
  FQUALIFIER G4double AlongStepDoIt(GPTrack* dp);
