		     ...
		     G4double *PDFX,G4double *PDFY, G4int *PDFA,G4double *PDFQ)
{
  ...
  GXMollerBhabha model(devStates,tid,1.0,1001.,NROW,NCOL,PDFX,PDFY);
		     ...
		     G4double *PDFX,G4double *PDFY, G4int *PDFA,G4double *PDFQ)
{
  ...
  while (tid < nTrackSize) {
    ...
    energy = track[tid].E;
    model.SampleByInversePDF(energy);
    track[tid].px = model.GetSecondaryEnergy()*model.GetSecondarySinTheta();
		     ...
		     G4double *PDFX,G4double *PDFY, G4int *PDFA,G4double *PDFQ)
{
  ...
  while (tid < nTrackSize) {
    energy = track[tid].E;
    model.SampleByInversePDFTexture(energy);
    track[tid].px = model.GetSecondaryEnergy()*model.GetSecondarySinTheta();
		     ...
		     G4double *PDFX,G4double *PDFY, G4int *PDFA,G4double *PDFQ)
{
  ...
  while (tid < nTrackSize) {
    energy = track[tid].E;
    model.SampleByInversePDFLinearInterpolation(energy);
    track[tid].px = model.GetSecondaryEnergy()*model.GetSecondarySinTheta();
		     ...
		     G4double *PDFX,G4double *PDFY, G4int *PDFA,G4double *PDFQ)
{
  ...
  while (tid < nTrackSize) {
    energy = track[tid].E;
    model.SampleByInversePDFTextureLinearInterpolation(energy);
    track[tid].px = model.GetSecondaryEnergy()*model.GetSecondarySinTheta();
		     ...
		     G4double *PDFX,G4double *PDFY, G4int *PDFA,G4double *PDFQ)
{
  ...
  GXMollerBhabha model(devStates,tid,1.0,1001.,NROW,NCOL,PDFA,PDFX,PDFQ);
  
  G4double energy = -999.;

  while (tid < nTrackSize) {
    energy = track[tid].E;
    model.SampleByAlias(energy);
    track[tid].px = model.GetSecondaryEnergy()*model.GetSecondarySinTheta();
		     ...
		     G4double *PDFX,G4double *PDFY, G4int *PDFA,G4double *PDFQ)
{
  ...
  while (tid < nTrackSize) {
    energy = track[tid].E;
    model.SampleByAliasLinearInterpolation(energy);
    track[tid].px = model.GetSecondaryEnergy()*model.GetSecondarySinTheta();
		     ...
		     G4double *PDFX,G4double *PDFY, G4int *PDFA,G4double *PDFQ)
{
  ...
  while (tid < nTrackSize) {
    ntrial = 0;
    energy = track[tid].E;
    model.SampleByCompositionRejection(energy,ntrial);
    track[tid].px = model.GetSecondaryEnergy()*model.GetSecondarySinTheta();
		     ...
		     G4double *PDFX,G4double *PDFY, G4int *PDFA,G4double *PDFQ)
{
  ...
  while (tid < nTrackSize) {
    ntrial = 0;
    energy = track[tid].E;
    model.SampleByAverageTrials(2.0,energy,ntrial);
    track[tid].px = model.GetSecondaryEnergy()*model.GetSecondarySinTheta();
	     ...
	     GXHistogramManager* theHisto)
{
  ...
  GXMollerBhabha model(devStates,tid,1.0,1001.,NROW,NCOL,PDFX,PDFY);
  GXMollerBhabha model2(devStates,tid,1.0,1001.,NROW,NCOL,PDFA,PDFX,PDFQ);
