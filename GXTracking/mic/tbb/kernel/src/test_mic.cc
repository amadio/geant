...
//-----------------------------------------------------------------------------
//  kernel for the coprocessor
//-----------------------------------------------------------------------------

GLOBALFUNC
void rk4_mic(GXFieldMap *magMap, GXTrack* track)
{
...
GLOBALFUNC
void rkf45_mic( GXFieldMap *magMap, GXTrack *track)
{
  GXMagneticField magField;    
  GXMagneticField_Constructor(&magField,magMap);
...
GLOBALFUNC
void nrk4_mic( GXFieldMap *magMap, GXTrack *track)
{
  GXMagneticField magField;    
  GXMagneticField_Constructor(&magField,magMap);
