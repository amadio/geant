...
GVComptonKleinNishina::GVComptonKleinNishina(Random_t* states, int threadId) 
  :
...
VECPHYS_CUDA_HEADER_BOTH 
GVComptonKleinNishina::~GVComptonKleinNishina() 
{
...
GVComptonKleinNishina::BuildOneTable( int Z, 
                                      const double xmin, 
                                      const double xmax,
                                      const int nrow,
                                      const int ncol)
...
VECPHYS_CUDA_HEADER_HOST void 
GVComptonKleinNishina::BuildPdfTable(int Z, 
                                     const double xmin, 
                                     const double xmax,
                                     const int nrow,
                                     const int ncol,
...
VECPHYS_CUDA_HEADER_HOST void 
GVComptonKleinNishina::BuildLogPdfTable(int Z, 
                                        const double xmin, 
                                        const double xmax,
                                        const int nrow,
                                        const int ncol,
...
GVComptonKleinNishina::CalculateDiffCrossSection( int Zelement, 
                                                  double energy0, 
...
GVComptonKleinNishina::VInteractKernel(double  energyIn, 
                                       int  zElement,
                                       double& energyOut,
                                       double& sinTheta)
{
  InteractKernel<kScalar>(energyIn,zElement,energyOut,sinTheta);
}    

#ifndef VECPHYS_NVCC
VECPHYS_CUDA_HEADER_BOTH void 
GVComptonKleinNishina::VInteractKernel(kVc::Double_t  energyIn, 
				 kVc::Index_t  zElement,
				 kVc::Double_t& energyOut,
				 kVc::Double_t& sinTheta)
{
  InteractKernel<kVc>(energyIn,zElement,energyOut,sinTheta);
}    
#endif

VECPHYS_CUDA_HEADER_BOTH 
void GVComptonKleinNishina::
