...
const double   CMSParticleGun::gInfBeamEnergy       =   1.*geant::GeV;
const double   CMSParticleGun::gSupBeamEnergy       = 100.*geant::GeV;
...
const std::string CMSParticleGun::gNameParticlesVector[CMSParticleGun::gNumberCandidateParticles] = {
  "e-",
  "e+",
  "gamma"
};
const std::map<std::string,int> CMSParticleGun::gPrimaryNameToIndexMap = {
  {"e-",   0},
  {"e+",   1},
  {"gamma",2}
};
...
CMSParticleGun::~CMSParticleGun() {}
  /*
CMSParticleGun::CMSParticleGun(int aver, int partpdg, double partekin, double xpos, double ypos, double zpos, double xdir,
		 double ydir, double zdir)
  : fIsUserNumPrimaryPerEvent(true)
