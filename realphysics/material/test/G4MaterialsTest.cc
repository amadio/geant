...
//
//
// $Id: G4MaterialsTest.cc 68721 2013-04-05 09:20:30Z gcosmo $
//
//
// ------------------------------------------------------------
//
...
for(int i=0; i<2; ++i) {
std::cout<<(*(H2O->GetElementVector()))[i]->GetName()<<"  --   massfrac["<<i<<"] = "    <<H2O->GetFractionVector()[i]<<std::endl;
std::cout<<(*(H2O->GetElementVector()))[i]->GetName()<<"  --   #atomspervol["<<i<<"] = "<<H2O->GetVecNbOfAtomsPerVolume()[i]/(1./cm3)<<std::endl;
std::cout<<(*(H2O->GetElementVector()))[i]->GetName()<<"  --   rel # atomspervol["<<i<<"] = "<<H2O->GetVecNbOfAtomsPerVolume()[i]/H2O->GetTotNbOfAtomsPerVolume()<<std::endl;
}
std::cout<<std::setfill('=')<<std::setw(90)<<" "<<std::setfill(' ')<<std::endl;
...
std::cout<<std::setfill('=')<<std::setw(90)<<" "<<std::setfill(' ')<<std::endl;
for(int i=0; i<2; ++i){
std::cout<<(*(Sci->GetElementVector()))[i]->GetName()<<"  --   massfrac["<<i<<"] = "    <<Sci->GetFractionVector()[i]<<std::endl;
std::cout<<(*(Sci->GetElementVector()))[i]->GetName()<<"  --   #atomspervol["<<i<<"] = "<<Sci->GetVecNbOfAtomsPerVolume()[i]/(1./cm3)<<std::endl;
std::cout<<(*(Sci->GetElementVector()))[i]->GetName()<<"  --   rel # atomspervol["<<i<<"] = "<<Sci->GetVecNbOfAtomsPerVolume()[i]/Sci->GetTotNbOfAtomsPerVolume()<<std::endl;
}
std::cout<<std::setfill('=')<<std::setw(90)<<" "<<std::setfill(' ')<<std::endl;
