...
// M.Novak: I made this method to like (readable) C++ but all the others (below and the one above) should look like :)
double GetHadronNucleonXscPDG(int particlePDG, double mass, double energyKin, int targetPDG) {
  ...
  // M. Novak: could't stand to change this
  //double term1  = B*std::pow(std::log(sMand/s0),2.);
