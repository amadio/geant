...
HadronNucleusXsc::GetHadronNucleonXscNS(int particlePDG, double mass, double energyKin, int targetPDG)
{
  ...
  //  else if( particlePDG == theAProton && pORn ) /////////////////// p_bar ///////////////////////////
  ...
  //  else if( particlePDG == thePiPlus && pORn ) // pi+ /////////////////////////////////////////////
  ...
  //  else if( particlePDG == thePiMinus && pORn ) /// pi- ////////////////////////////////////////////
  else if( particlePDG == -211 && pORn ) /// pi- ////////////////////////////////////////////
  {
    if( neutron )     // pi- n = pi+ p??
    {
  ...
  //else if( (particlePDG == theKMinus || particlePDG == theK0S) && proton )   // Kmp/K0p //////
  ...
  //  else if( (particlePDG == theKMinus || particlePDG == theK0S) && neutron )   // Kmn/K0n ///////
  ...
  //  else if(  (particlePDG == theKPlus || particlePDG == theK0L) && proton  )  // Kpp/aKp ////////////////////////
  ...
  //  else if(  (particlePDG == theKPlus || particlePDG == theK0L) && neutron  )  // Kpn/aKn ///////////////////////
  ...
  //  else if( particlePDG == theSMinus && pORn ) 
