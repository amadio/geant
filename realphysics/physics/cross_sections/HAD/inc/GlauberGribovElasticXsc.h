...
inline double GlauberGribovElasticXsc::GetParticleBarCorTot(int particlePDG, int Z)
{
  if(Z >= 2 && Z <= 92)
  {
...
inline double GlauberGribovElasticXsc::GetParticleBarCorIn(int particlePDG, int Z)
{
  if(Z >= 2 && Z <= 92)
  {
