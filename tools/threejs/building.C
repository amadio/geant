...
void building()
{
  ...
  while (F < nF) {
    ...
    while (i < nW) {
      ...
      if (i >= nW) {
        ...
        mBlocks->SetLineColor(2);
        Phy_Building->AddNodeOverlap(mBlocks, 1, new TGeoCombiTrans(21.4 + (-21) * 0.13, -21 + (-21) * 0.99,
                                                                    hP + (8 * F), new TGeoRotation("r1", -7.5, 0, 0)));
      }
    }
    ...
    mBlocks->SetLineColor(2);
    Phy_Building->AddNodeOverlap(mBlocks, 1,
                                 new TGeoCombiTrans(21.4, -21, hP - 12 + (8 * F), new TGeoRotation("r1", -7.5, 0, 0)));
  }
  ...
  mBlocks->SetLineColor(18);
  Phy_Building->AddNodeOverlap(mBlocks, 1,
                               new TGeoCombiTrans(21.43, -20.75, hP - 2 + (8 * F), new TGeoRotation("r1", -7.5, 0, 0)));
