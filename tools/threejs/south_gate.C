...
void south_gate()
{
  ...
  while (i < 7) {
    while (k < 44) {
      ...
      top->AddNodeOverlap(mBlock, 1, new TGeoCombiTrans(-280 + (k * 13), 70 + (i * 12.5), 425 - (i * 5),
                                                        new TGeoRotation("r1", 0, 60, 0)));
      k++;
    }
    i++;
    k = 0;
  ...
  while (i < 11) {
    while (k < 43) {
      ...
      top->AddNodeOverlap(mBlock, 1, new TGeoCombiTrans(-270 + (k * 13), 15 + (i * 12.5), 620 - (i * 5),
                                                        new TGeoRotation("r1", 0, 60, 0)));
      k++;
    }
    i++;
  ...
  while (i < 10) {
    while (k < 11) {
      ...
      mBlock->SetLineColor(13);
      top->AddNodeOverlap(mBlock, 1,
                          new TGeoCombiTrans(-283, 37.5 + (i * 12.5), 615 - (i * 4), new TGeoRotation("r1", 0, 60, 0)));
      k++;
    }
    i++;
    k = 0;
  ...
  while (i < 6) {
    while (k < 11) {
      ...
      mBlock->SetLineColor(13);
      top->AddNodeOverlap(
          mBlock, 1, new TGeoCombiTrans(-335, -81.25 - (i * 12.5), 592.5 - (i * 2), new TGeoRotation("r1", 0, 120, 0)));
      k++;
    }
    i++;
    k = 0;
  ...
  while (i < 9) {
    while (k < 11) {
      ...
      mBlock->SetLineColor(13);
      top->AddNodeOverlap(mBlock, 1,
                          new TGeoCombiTrans(-296, -50 - (i * 12.5), 610 - (i * 4), new TGeoRotation("r1", 0, 120, 0)));
      k++;
    }
    i++;
    k = 0;
  ...
  while (i < 7) {
    while (k < 11) {
      ...
      mBlock->SetLineColor(13);
      top->AddNodeOverlap(mBlock, 1,
                          new TGeoCombiTrans(322, 69.75 + (i * 12.5), 595 - (i * 2), new TGeoRotation("r1", 0, 60, 0)));
      k++;
    }
    i++;
    k = 0;
  ...
  while (i < 8) {
    while (k < 11) {
      ...
      mBlock->SetLineColor(13);
      top->AddNodeOverlap(mBlock, 1,
                          new TGeoCombiTrans(309, 56.25 + (i * 12.5), 605 - (i * 4), new TGeoRotation("r1", 0, 60, 0)));
      k++;
    }
    i++;
    k = 0;
