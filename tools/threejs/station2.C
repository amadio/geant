...
void station2()
{
  ...
  while (f < 4) {
    ...
    while (i < 30) {
      ...
      top->AddNodeOverlap(mBlock, 1,
                          new TGeoCombiTrans(15 + (i * 5), 75, -65 + (f * 7), new TGeoRotation("z", 0, 0, 0)));
      i++;
    }
    f++;
  }
  ...
  while (f < 4) {
    ...
    while (i < 30) {
      ...
      top->AddNodeOverlap(mBlock1, 1,
                          new TGeoCombiTrans(14 + (i * 5), 75, -100 + (f * 7), new TGeoRotation("z", 0, 0, 0)));
      i++;
    }
    f++;
  }
  ...
  while (f < 4) {
    ...
    while (i < 30) {
      ...
      top->AddNodeOverlap(mBlock2, 1,
                          new TGeoCombiTrans(-160 + (i * 5), 75, -75 + (f * 7), new TGeoRotation("z", 0, 0, 0)));
      i++;
    }
    f++;
  }
  ...
  while (f < 4) {
    ...
    while (i < 30) {
      ...
      top->AddNodeOverlap(mBlock3, 1,
                          new TGeoCombiTrans(-160 + (i * 5), 75, -110 + (f * 7), new TGeoRotation("z", 0, 0, 0)));
      i++;
    }
    f++;
  }
